...
//A layout in Java which allows for the altering of the layout in the components onto the JFrame.
...
//This allows us to find the height and width of a component.
import java.awt.Dimension;
//ALlows the use of graphical objects.
import java.awt.Graphics;
//Built in class which gives an x, y location.
...
//This identifies events which is generated by a component when a key is pressed, released or typed. This hands the event to the KeyListener.
import java.awt.event.KeyEvent;
//Provides methods and classes for dealing with events sent by the KeyEvent.
import java.awt.event.KeyListener;
//Like an ArrayList, however more efficient for our purposes as we do not have to find any random positions (reads from first to last) within the list (something in which the ArrayList exceeds in). It performs like an array which stores elements in a list, we can call methods such as remove.
import java.util.LinkedList;
//Creates random numbers
import java.util.Random;

//This allows for the usage of the methods for JButtons
import javax.swing.JButton;
//This imports the JFrame class from the swing package.
import javax.swing.JFrame;
//This is used to contain JPanels at different levels
import javax.swing.JLayeredPane;
//This allows us to put the component(s) into the JFrame.
import javax.swing.JPanel;
//This allows us to perform an action for every tick.
...
public class Board implements ActionListener, KeyListener {
	...
	//Creating a variable fruit of type Fruit.
	public Fruit fruit;
	//Creating a variable filler of type Filler.
	...
	//Sets the dimension. This will be used to find the dimension of the screen.
